...
SECRET_KEY = 'django-insecure-7)kkk$^nkl3(x2$+!hdkwr-ojq!6b3jw+)p%i)c-z!7b%wl&6w'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'titan-strength'
...
DEFAULT_FROM_EMAIL = 'titanstrength@example.com'
